...
listeB = [0.41664447909931157, 0.0009128599140390247, 0.001103039062797155, 0.0009889315735422768, 0.0009889315735422768, 0.0008748240842873987, 0.001103039062797155, 0.0004944657867711384, 0.0007987524247841467, 0.0009128599140390247, 0.0006085732760260166, 0.0007607165950325206, 0.0003803582975162603, 0.0005705374462743905, 0.0007987524247841467, 0.0006085732760260166, 0.0007987524247841467, 0.0010269674032939028, 0.0018257198280780494, 0.5677988665322734]
...
"""
f.write(';')
f.write(str(decallage))
f.write(';')
f.write(str(bruiteur))
f.write(';')
f.write(str(echelle))
f.write(';')
f.write(str(spliteur))
f.write(';'))
f.write(str(suppression))
f.write(';')
f.write(str(calcul(density , listeB)))
f.write(';')
"""
